...
//       if (args != null && args.containsKey('locationNum')) {
//         setState(() {
...
//             onPressed: () {
//               // Navigate to a custom screen, e.g., ChooseLocationScreen
...
//                               imagePath), // استخدام CachedNetworkImageProvider بدلاً من NetworkImage
//                           fit: BoxFit.fill,
//                         ),
//                         border:
...
//       // Simulate image processing or any task here
//       await Future.delayed(
//           Duration(seconds: 2)); // Simulate delay (e.g., image processing)
...
//                         image: DecorationImage(
//                           image: CachedNetworkImageProvider(
//                               imagePath), // use CachedNetworkImageProvider
//                           fit: BoxFit.fill,
//                         ),
//                         border:
//                             Border.all(color: Colors.grey.shade400, width: 3),
