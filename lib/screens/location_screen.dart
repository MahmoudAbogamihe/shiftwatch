...
class _LocationScreenState extends State<LocationScreen> {
  ...
  void _savePolygons() {
    if (_polygons.isNotEmpty) {
      String formattedPolygons = _formatPolygonForNumpy(_polygons);
      print("Polygon Dimensions as NumPy arrays:\n$formattedPolygons");
      print(theEditionVariable);
    } else {
              ...
              child: Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: Text(_isDrawing ? 'Finish ' : 'Start '),
                  ),
                ],
              ),
            ),
          ...
          Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  print('SSSSSSSSSS$finalPolygons');
                  print("عدد المضلعات المرسومة: ${_polygons.length}");
                  print("المفروض ترسم: $maxPolygons");

                  final result = (allLocationsData != null)
                      ? await Navigator.pushNamed(
                          context,
                          EmployeeSetupScreen.screenRoute,
                          arguments: {
                            'polygonDimensions':
                                polygonListString, // تمرير List<String>
                            'maxPolygons': maxPolygons,
                            'theEditionVariable': theEditionVariable,
                      ...
                      : await Navigator.pushNamed(
                          ...
                          arguments: {
                            'polygonDimensions':
                                finalPolygons, // تمرير List<String>
                            'maxPolygons': maxPolygons,
                            'theEditionVariable': theEditionVariable,
                            'locationNum': locationNum,
                            'userName': userName,
                  ...
                  if (result is List<List<Offset>> && result != _polygons) {
                    setState(() {
                      _polygons = result;
                    });
                    _savePolygons();
